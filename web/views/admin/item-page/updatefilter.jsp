                        ...
                        <div class="row justify-content-center align-items-center h-100">
                            <div class="col-12 col-lg-9 col-xl-7">
                                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                                    ...
                                    <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Edit Permissions</h3>

                                    <form action="updateFilter" method="post" onsubmit="return confirmUpdate();">
                                        <c:set value="${authorRes}" var="oRes"/>
                                        <div class="row">
                                            <div class="col-md-6 mb-4">

                                                <div data-mdb-input-init class="form-outline">
                                                    <input required type="text" id="firstName" value="${oRes.url}" class="form-control form-control-lg" name="url" />
                                                    <label class="form-label" for="firstName">URL</label>
                                                </div>
                                                <input readonly type="text" style="display: none" name="idAuthor" class="form-control form-control-lg" value="${oRes.id}" />
                                            </div>                                          
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4 d-flex align-items-center">
                                                ...
                                                <div data-mdb-input-init class="form-outline datepicker w-100">
                                                    <input required type="text" value="${oRes.feature}" class="form-control form-control-lg"  name="feature" />
                                        ...
                                        <div class="row">
                                                ...
                                                <select required name="role" class="select form-control-lg">
                                                    <c:forEach items="${listRole}" var="o">
                                                        <c:if test="${o.roleId != 5}">
                                                            <option value="${o.roleId}"  ${oRes.role.roleId eq o.roleId ? 'selected' : ""}>${o.roleName}</option>
                                                        </c:if>
                                                    </c:forEach>
                                                </select>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <select name="status" class="select form-control-lg">
                                                    ...
                                                    <option value="0" ${oRes.status == 0 ? "selected" : ""}>Active</option>
                                                    <option value="1" ${oRes.status == 1 ? "selected" : ""}>Inactive</option>
                                                </select>
