                                    ...
                                    <form action="addUser" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <div data-mdb-input-init class="form-outline">
                                                    <input required type="text" id="firstName" value="${not empty nameRes  ? nameRes : ""}" class="form-control form-control-lg" name="fullName" />
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <div data-mdb-input-init class="form-outline">
                                                    <input required type="password" value="${passRes ne null ? passRes : ""}" id="lastName" class="form-control form-control-lg" name="password" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4 d-flex align-items-center">
                                                ...
                                                <div data-mdb-input-init class="form-outline datepicker w-100">
                                                    <input required type="email" value="${emailRes ne null ? emailRes : ""}" class="form-control form-control-lg" id="birthdayDate" name="email" />
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="gender" id="femaleGender"
                                                           value="0" ${genRes eq '0' ? 'checked' : ""} required />
                                                    <label class="form-check-label" for="femaleGender">Female</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="gender" id="maleGender"
                                                           value="1" ${genRes eq '1' ? 'checked' : ""} />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4 pb-2">
                                                ...
                                                <div data-mdb-input-init class="form-outline">
                                                    <input type="tel" value="${phoneRes ne null ? phoneRes : ""}" id="emailAddress" class="form-control form-control-lg" name="phone" />
                                            ...
                                            <div class="col-md-6 mb-4 pb-2">
                                                ...
                                                <div data-mdb-input-init class="form-outline">
                                                    <input type="text" value="${addRes ne null ? addRes : ""}" id="phoneNumber" class="form-control form-control-lg" name="address" />
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <c:forEach items="${listRole}" var="o">
                                                    <c:if test="${o.getRoleName() != 'Anonymous'}">
                                                    <option value="${o.roleId}"  ${roleRes eq o.roleId ? 'selected' : ""}>${o.roleName}</option>
                                                    </c:if>
                                                    </c:forEach>
                                                </select>
                                        ...
                                        <div class="mt-4 pt-2">
                                            ...
                                            <input data-mdb-ripple-init class="btn btn-primary btn-lg submit" style="width: 88px;" onsubmit="false" onclick="location.href='userList'" value="Back" />
                                        </div>
                                    </form>
